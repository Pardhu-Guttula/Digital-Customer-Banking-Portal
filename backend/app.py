...
from backend.notifications.controllers.email_notification_controller import email_notification_bp
...
app.register_blueprint(email_notification_bp, url_prefix='/api')
